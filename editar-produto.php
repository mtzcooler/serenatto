...
if (isset($_POST['editar'])){
  ...
  $produto = $repositorio->buscarProdutoPorId($_GET['id']);
}
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="container-radio">
        <div>
            ...
            <input type="radio" id="cafe" name="tipo" value="Café" <?= $produto->getTipo() == 'cafe' ? "checked" : "" ?>>
        </div>
        <div>
            <label for="almoco">Almoço</label>
            <input type="radio" id="almoco" name="tipo" value="Almoço" <?= $produto->getTipo() == 'almoco' ? "checked" : "" ?>>
        </div>
    </div>
